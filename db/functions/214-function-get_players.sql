...
BEGIN
  ...
  JOIN public.player p ON s.game_id = p.game_id
...
GRANT EXECUTE ON FUNCTION public.get_players(integer, character varying, character varying) TO anon, authenticated;